 ...
 */
let generateServerMakeCredRequest = (username, displayName, id, attestationType) => {
    return {
        ...
        authenticatorSelection: {
            authenticatorAttachment: attestationType,
            userVerification: "required",
            requireResidentKey: false
        },

        // As defined here: https://www.iana.org/assignments/cose/cose.xhtml#algorithms
        pubKeyCredParams: [
